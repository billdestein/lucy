...
The PicListComponent iterates over the pics in the workbook.  The empty sentinel
(filename: 'empty') is always pinned to the top of the list, regardless of its createdAt.
The remaining pics follow it, sorted by createdAt descending (newest first).  For each pic,
