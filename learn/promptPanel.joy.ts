...
The PromptPanel is a React component that wraps Frame.

The PromptPanel has a 'prompt' in its message.  The prompt is displayed in the viewport.
...
The cancel button handler removes the PromptPanel from the canvas.
`
